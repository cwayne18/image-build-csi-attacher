# image-build-csi-attacher

This repo builds hardened, statically-linked Go binaries from
[kubernetes-csi/external-attacher](https://github.com/kubernetes-csi/external-attacher) and packages them in a minimal
...
- `cwayne18/hardened-csi-attacher` — CSI Attacher Sidecar
...
- the upstream `external-attacher` version (`Makefile` `TAG`), and
